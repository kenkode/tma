                        ...
                        <ul class="list-group clear-list m-t">
                            <li class="list-group-item fist-item">
                                <span class="pull-right">
                                  <?php echo e($currency.' '.number_format($payments,2)); ?>

                                </span>
                                <span class="label label-primary">1</span> Total Payments
                            </li>
                            ...
                            <li class="list-group-item">
                                ...
                                <span class="label label-success">2</span> Total Bookings
                            </li>
                            <li class="list-group-item">
                                <span class="pull-right">
                                ...
                                <span class="label label-warning">3</span> Total Customers
                            </li>
                            ...
                            <li class="list-group-item">
                                ...
                                <span class="label label-success">4</span> Cars
                            </li>
                            <!-- <li class="list-group-item">
                                <span class="pull-right">
                                    <?php echo e($schedules); ?>

                                </span>
                                <span class="label label-warning">5</span> Schedules
                            </li> -->
                                            ...
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="<?php echo e(url('/assets/img/profile.jpg')); ?>">
                                                    </a>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="<?php echo e(url('/assets/img/a2.jpg')); ?>">
                                                    </a>
                                                    <div class="media-body ">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="<?php echo e(url('/assets/img/a3.jpg')); ?>">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="<?php echo e(url('/assets/img/a4.jpg')); ?>">
                                                    </a>
                                                    <div class="media-body ">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="<?php echo e(url('/assets/img/a5.jpg')); ?>">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="<?php echo e(url('/assets/img/a7.jpg')); ?>">
                                                    </a>
                                                    <div class="media-body ">
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('Welcome <?php echo e(Auth::user()->name); ?>');
